...
To cite the paper: 
> Marcello Mezzasalma, Jeffrey W Streicher, Fabio M. Guarino, Marc EH Jones, Simon P Loader, Gaetano Odierna, and Natalie Cooper 2022. Microchromosome fusions underpin convergent evolution of chameleon karyotypes. TBC.
...
ChromEvol package cite and R package link too

## Data
All cleaned data are available from the [NHM Data Portal](TO ADD).
