...
Four species have OTUs with different numbers of chromosomes, so these should be retained. Otherwise collapse OTUs to species at tips
```{r}
mydata2 <- mydata %>%
...
#Species level
write_csv(mydata, file = here("data/chromosome-data-species.csv"))
