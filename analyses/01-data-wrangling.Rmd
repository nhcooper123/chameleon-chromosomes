...
Read in the data. 
```{r, message = FALSE}
ds <- read_csv(here("data/chromosomes/CHROMO_STATES_2020-09-10.csv"))
```
...
ds <- ds %>%
  ...
  # Correct the taxonomy so it matches teh ecology dataset
...
Add the ecological data from Meiri 2018 and match up to the chromosome data. This prints out the species there are no matching data for in Meiri 2018 (should be 6 species). These species remain in the dataset, but don't have matching ecological data.
```{r, message = FALSE}
