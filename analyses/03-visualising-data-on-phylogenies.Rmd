...
genus_tree <-
  ...
  geom_cladelabel(node = MRCA(circ, mydata$tips[mydata$genus == "Bradypodion"]), 
                ...
                align =FALSE, offset = 1, fontsize = 4, offset.text = 40) +
  ...
  geom_cladelabel(node = MRCA(circ, mydata$tips[mydata$genus == "Rhampholeon"]),
                ...
                align = TRUE,offset = 1, fontsize = 4, offset.text = 90) +
  geom_cladelabel(node = MRCA(circ, mydata$tips[mydata$genus == "Trioceros"]),
                  label = expression(italic("Trioceros")), 
                align = TRUE, offset = 1, fontsize = 4, offset.text = 65)

# Save tree
# ggsave(genus_tree, filename = here("outputs/trees-genera-bw.png"), height = 5)
...
groupOTU(circ, grp2, 'Genus') + aes(color = Genus) +
  ...
  scale_colour_manual(values = mycolours, name = "", 
                      ...
                      labels = c(expression(italic("Bradypodion")),
                                 ...
                                 expression(italic("Trioceros")))) +   theme(legend.text.align = 0)

# Save tree
# ggsave(filename = here("outputs/trees-genera-colour-legend.png"), height = 5)
