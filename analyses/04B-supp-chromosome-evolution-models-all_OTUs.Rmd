...
for (i in 1:12) {
  ...
  resultsCR <- read.ce(here(paste0("chromEvol/OTUs/", output_names[i], "/CONST_RATE")))
  resultsCD <- read.ce(here(paste0("chromEvol/OTUs/", output_names[i], "/CONST_RATE_DEMI")))
  resultsCDE <- read.ce(here(paste0("chromEvol/OTUs/", output_names[i], "/CONST_RATE_DEMI_EST")))
  resultsL <- read.ce(here(paste0("chromEvol/OTUs/", output_names[i], "/LINEAR_RATE_NO_DUPL")))
  resultsLR <- read.ce(here(paste0("chromEvol/OTUs/", output_names[i], "/LINEAR_RATE")))
  resultsLD <- read.ce(here(paste0("chromEvol/OTUs/", output_names[i], "/LINEAR_RATE_DEMI")))
  resultsLDE <- read.ce(here(paste0("chromEvol/OTUs/", output_names[i], "/LINEAR_RATE_DEMI_EST")))
...
output
#write_csv(output, path = here("outputs/OTUs/chromEvol-model-summaries-ALL-MODELS.csv"))
```