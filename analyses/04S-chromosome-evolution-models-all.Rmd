...
for (i in 1:12) {
  ...
  resultsCR <- read.ce(here(paste0("chromEvol/", output_names[i], "/CONST_RATE")))
  resultsCD <- read.ce(here(paste0("chromEvol/", output_names[i], "/CONST_RATE_DEMI")))
  resultsCDE <- read.ce(here(paste0("chromEvol/", output_names[i], "/CONST_RATE_DEMI_EST")))
  resultsL <- read.ce(here(paste0("chromEvol/", output_names[i], "/LINEAR_RATE_NO_DUPL")))
  resultsLR <- read.ce(here(paste0("chromEvol/", output_names[i], "/LINEAR_RATE")))
  resultsLD <- read.ce(here(paste0("chromEvol/", output_names[i], "/LINEAR_RATE_DEMI")))
  resultsLDE <- read.ce(here(paste0("chromEvol/", output_names[i], "/LINEAR_RATE_DEMI_EST")))
