...
for (i in 0:999) {
  # Choose directory
  dir <- paste0("chromEvol/OTUs/chromEvol_out_simulations/", i, "/")
  # Read in counts data
...
write_csv(sim_output, path = here("data/OTUs/chromevol-simulations-outputs.csv"))
```
...
write_csv(sims_output_null, path = here("data/OTUs/null-simulations-outputs.csv"))
```