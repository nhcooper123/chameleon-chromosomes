...
sim_output <- read_csv(here("data/chromevol-simulations-outputs-best.csv"))
...
#ggsave(filename = here("outputs/all-simulations-differences-best.png"))  
...
#ggsave(filename = here("outputs/chromevol-simulations-numbers-best.png"), height = 5)  
```
